...
# model.load_state_dict(torch.load(r'C:\Users\scarl\OneDrive\桌面\UCB MEng EECS\CS294-082\cs29482-final-master\log\1116_174752_512_test\best_checkpoint.pth.tar'), strict=False)
